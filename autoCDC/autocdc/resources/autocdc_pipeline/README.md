...
This folder defines all source code for the autocdc_pipeline pipeline:
...
* Take a look at the sample under "sample_trips_autocdc.py" to get familiar with the syntax.
